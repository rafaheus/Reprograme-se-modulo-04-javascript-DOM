...
// getElementsByTagName / retorna um array
...
// getElementsByName / retorna um array
var array_cidade = document.getElementsByName("cidade");
var cidade_0 = array_cidade[0];
cidade_0.style.borderLeftColor = "Yellow";

// getElementsByClassName / retorna um array
var array_cidade_mg = document.getElementsByClassName("cidade-mg");
var cidade_mg_1 = array_cidade_mg[1];
cidade_mg_1.style.borderLeftColor = "Green";

// querySelector / selecion a pela query, classe, id etc / seleciona o primeiro elemento com a query desejada
